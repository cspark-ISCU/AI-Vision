...
def make_posegraph_for_fragment(path_dataset, sid, eid, color_files,
    ...
    pose_graph = o3d.registration.PoseGraph() #    pose_graph = o3d.pipelines.registration.PoseGraph()
    trans_odometry = np.identity(4)
    pose_graph.nodes.append(
        o3d.registration.PoseGraphNode(trans_odometry)) # o3d.pipelines.registration.PoseGraphNode(trans_odometry))
